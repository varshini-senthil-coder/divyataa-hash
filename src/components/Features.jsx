  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-10">
        <div className="absolute top-20 left-10 w-72 h-72 bg-purple-10 rounded-full blur-[30px]" />
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-pink-50 rounded-full blur-[100px]" />
      </div>
