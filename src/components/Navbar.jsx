...
const Navbar = () => {
  ...
  const isExperiencePage = location.pathname === '/campus';
          ...
          <Link to="/" className="flex flex-col items-start gap-0 relative">
            <div className="relative">
              <img 
                src={logo} 
                alt="Divyataa Logo" 
                className={`transition-all duration-300 ${(isScrolled || isInnerPage || isMobileMenuOpen) ? 'h-12 md:h-16' : 'h-24 md:h-35'} w-auto`} 
              />
