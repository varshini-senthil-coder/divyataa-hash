...
const CTA = () => {
  return (
    <section className="relative w-full py-10 md:py-10 px-5 overflow-hidden bg-transparent">
      <div className="max-w-4xl mx-auto text-center relative z-10 space-y-6 sm:space-y-8 md:space-y-10">
        ...
        <p className="text-black text-xs md:text-sm font-semibold pt-2">
          Or call us directly: <a href="tel:9751112300" className="hover:text-[#7208b3] transition-colors">+91 97511 12300</a> & <a href="tel:8428412300" className="hover:text-[#7208b3] transition-colors">+91 84284 12300</a>
        </p>
      </div>
    </section>
  );
