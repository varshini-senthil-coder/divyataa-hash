...
const testimonials = [
  {
    ...
    author: "Prakash", occupation: "Software Engineer",
  ...
  },
  {
    ...
    author: "S. Revathi", occupation: "Teacher",
  ...
  },
  {
    ...
    author: "Yuganya Rajmohan", occupation:"Doctor",
  ...
  },
  {
    ...
    author: "Selvakumar", occupation:"Businessman",
  ...
  },
  {
    ...
    author: "Ankita Tiwari", occupation:"Software Developer",
  ...
  },
  {
    ...
    author: "Jenifer Antony", occupation:"Teacher",
  ...
  },
  {
    ...
    author: "Narmadha", occupation:"HR Manager",
...
const Testimonials = () => {
  ...
  return (
    <section className="py-0 bg-transparent relative overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-5 relative z-10">
        <div className="text-center mb-16 space-y-4">
          <motion.span 
            ...
            viewport={{ once: true }}
            className="inline-block px-0 py-0 rounded-full bg-purple-50 text-purple-600 font-bold tracking-widest text-[10px] md:text-xs uppercase shadow-sm border border-purple-100/50"
          >
            Our Community
          </motion.span>
          <motion.h2 
            ...
            className="text-3xl md:text-4xl lg:text-5xl font-gayathri text-slate-900 leading-tight font-bold"
          >
            From Our Parents
          </motion.h2>
          <motion.div 
        ...
        <div className="relative group/slider" 
          ...
          <div className="overflow-visible md:overflow-hidden py-2">
            <motion.div
                  ...
                  <div className="h-full bg-white/90 backdrop-blur-md p-8 md:p-12 rounded-[2.5rem] border border-purple-100 shadow-2xl shadow-purple-500/5 flex flex-col relative overflow-hidden group hover:border-purple-300 transition-all duration-500">
                    ...
                    <div className="flex items-center gap-5 mt-auto">
                      ...
                      <div>
                        ...
                        {testimonial.occupation && <p className="text-slate-500 text-sm italic mt-1"> {testimonial.occupation}</p>}
