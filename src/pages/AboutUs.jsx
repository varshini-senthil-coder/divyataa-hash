...
const AboutUs = () => {
  ...
  <div className="max-w-7xl mx-auto text-center relative z-10">
    ...
    <motion.h1
      ...
      className="text-xl md:text-4xl font-gayathri text-white mb-6 leading-tight font-bold"
    >
      About Us
    </motion.h1>
    ...
    >
      ...
      <section className="py-8 md:py-12 px-6 bg-white relative">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <p className="text-purple-600 font-bold text-sm uppercase tracking-widest">A Legacy of Purpose</p>
            <br></br>
          <h2
    ...
    {q.short}
      ...
      <section className="py-20 md:py-28 px-6 bg-slate-900 text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <motion.div
            variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}
            className="mt-20 md:mt-20 max-w-4xl mx-auto border-t border-white/10 pt-20"
          >
            <div className="flex justify-center gap-2 mb-10 px-2 whitespace-now">
  ...
  <div className="max-w-6xl mx-auto relative z-10">
    ...
    <div className="flex flex-col md:flex-row items-center gap-10">
      ...
      <div className="flex-1 text-center md:text-left">
        <span className="text-5xl md:text-8xl text-purple-200 block mb-3 leading-none">
          "
        </span>

        <blockquote className="md:text-2xl text-slate-800 leading-snug">
